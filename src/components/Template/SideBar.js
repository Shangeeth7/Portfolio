  ...
  <section id="sidebar">
    ...
    <section className="blurb">
      ...
      <ul className="actions">
        <li>
          {!window.location.pathname.includes('/resume') ? <a target="_blank" rel="noreferrer" href="https://drive.google.com/drive/folders/1yNCw7e0_SgHAeC257KVcp38nekl13nzd" className="button">Resume</a> : <Link to="/contact" className="button">Contact Me</Link>}
        </li>
      </ul>
    </section>
